...
public:
    ...
    void setupUi(QDialog *ContactExaminerDlgUI)
    {
        ...
        ContactExaminerDlgUI->resize(301, 321);
        ...
        objectRadioButton->setGeometry(QRect(80, 16, 81, 19));
        ...
        handRadioButton->setGeometry(QRect(11, 16, 71, 19));
        showGWSButton = new QPushButton(ContactExaminerDlgUI);
        showGWSButton->setObjectName(QString::fromUtf8("showGWSButton"));
        showGWSButton->setGeometry(QRect(20, 260, 101, 30));
