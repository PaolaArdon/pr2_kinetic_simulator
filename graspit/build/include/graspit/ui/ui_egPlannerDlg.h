...
public:
    ...
    void setupUi(QDialog *EigenGraspPlannerDlgUI)
    {
        ...
        EigenGraspPlannerDlgUI->resize(652, 559);
        ...
        line1_2_2_2->setGeometry(QRect(10, 62, 321, 20));
        ...
        iterationLabel->setGeometry(QRect(170, 169, 140, 20));
        ...
        annStepsEdit->setGeometry(QRect(210, 77, 91, 20));
        ...
        onlineDetailsGroup->setGeometry(QRect(300, 330, 351, 220));
    ...
    void retranslateUi(QDialog *EigenGraspPlannerDlgUI)
    {
        ...
        plannerStartButton->setText(QApplication::translate("EigenGraspPlannerDlgUI", "Start", 0, QApplication::UnicodeUTF8));
